                            ...
                            <div class="card-header">
                                ...
                                <a href="<?= base_url(); ?>user/tambah">
                                    <button style="float: right;" class="btn waves-effect waves-light btn-primary">
                                        <i class="icofont icofont-plus"></i> Tambah User
                                    </button>
                                </a>
                                <span></span>
                            </div>
...
function buttonDelete(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            document.location.href = "<?= base_url(); ?>user/hapus/" + id;
        }
    })
}
...
function buttonReset(id) {
    Swal.fire({
        text: 'Anda yakin ingin mereset data ini?',
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
        ...
        if (result.isConfirmed) {
            document.location.href = "<?= base_url(); ?>user/reset/" + id;
        }
    })
}
