                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5>Tabel Ruangan</h5>
                                <a href="<?= base_url(); ?>ruangan/tambah">
                                    <button style="float: right;" class="btn waves-effect waves-light btn-primary">
                                        <i class="icofont icofont-plus"></i> Tambah Ruangan
                                    </button>
                                </a>
                                <span></span>
                            </div>
...
$(document).ready(function() {
    ...
    $('#simpletable').DataTable({
        ...
        "order": [],
        "ajax": {
            "url": "<?php echo site_url('ruangan/list_ruangan'); ?>",
            "type": "POST",
            "data": {},
...
function buttonDelete(id) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            document.location.href = "<?= base_url(); ?>ruangan/hapus/" + id;
        }
    })
}
