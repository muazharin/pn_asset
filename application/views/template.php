...
<head>
    ...
    <!-- waves.css -->
    <link rel="stylesheet" href="<?= base_url() ?>assets_temp/pages/waves/css/waves.min.css" type="text/css" media="all">
    <!-- Required Fremwork -->
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets_temp/icon/font-awesome/css/font-awesome.min.css">
    <!-- scrollbar.css -->
...
<body>
            ...
            <nav class="navbar header-navbar pcoded-header">
                <div class="navbar-wrapper">
                    <div class="navbar-logo">
                        ...
                        <a href="index.html">
                            <img class="img-fluid" src="<?= base_url() ?>assets_temp/images/logo.png" alt="Theme-Logo" />
                        </a>
                    ...
                    <div class="navbar-container container-fluid">
                        ...
                        <ul class="nav-right">
                            <!-- <li class="header-notification">
                                ...
                                <ul class="show-notification">
                                    ...
                                    <li class="waves-effect waves-light">
                                        <div class="media">
                                            <img class="d-flex align-self-center img-radius" src="<?= base_url() ?>assets_temp/images/avatar-2.jpg" alt="Generic placeholder image">
                                            <div class="media-body">
                                                <h5 class="notification-user">Administrator</h5>
                                    ...
                                    <li class="waves-effect waves-light">
                                        <div class="media">
                                            <img class="d-flex align-self-center img-radius" src="<?= base_url() ?>assets_temp/images/avatar-4.jpg" alt="Generic placeholder image">
                                            <div class="media-body">
                                    ...
                                    <li class="waves-effect waves-light">
                                        <div class="media">
                                            <img class="d-flex align-self-center img-radius" src="<?= base_url() ?>assets_temp/images/avatar-3.jpg" alt="Generic placeholder image">
                                            <div class="media-body">
                            ...
                            <li class="user-profile header-notification">
                                <a href="#!" class="waves-effect waves-light">
                                    <img src="<?= base_url() ?>assets_temp/images/avatar-7.png" class="img-radius" alt="User-Profile-Image">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            <div class="">
                                <div class="main-menu-header">
                                    <img class="img-80 img-radius" src="<?= base_url() ?>assets_temp/images/avatar-7.png" alt="User-Profile-Image">
                                    <div class="user-details">
                                        <span id="more-details">Administrator</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li>
                                    <a href="<?= base_url();?>" class="waves-effect waves-dark">
                                        ...
                                        <span class="pcoded-mtext" data-i18n="nav.dash.main">Aset</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">Selamat Datang di PN Assets Management</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
    ...
    <script type="text/javascript" src="<?= base_url() ?>assets_temp/js/jquery-slimscroll/jquery.slimscroll.js "></script>
    <!-- modernizr js -->
